from telegram import Update, Bot, InlineKeyboardButton, InlineKeyboardMarkup, WebAppInfo, CallbackGame
...
async def start(update: Update, context: CallbackContext):
    ...
    keyboard = [
        [
            InlineKeyboardButton(text="小程序", callback_game=CallbackGame("thisiswatsonsdemogame"))
